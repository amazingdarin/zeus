...
- [x] 创建 `packages/doc-editor-openapi` 包结构与 `package.json`
...
- [x] OpenAPI node/viewer 迁移至 `@zeus/doc-editor-openapi`
...
- [x] `frontend` 改为 workspace 依赖新包（`@zeus/doc-editor`、`@zeus/doc-editor-openapi`）
