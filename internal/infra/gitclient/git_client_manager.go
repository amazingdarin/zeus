...
type ClientFactory func(key GitKey) *GitClient
...
func NewGitClientManager(factory ClientFactory) *GitClientManager {
	if factory == nil {
		factory = func(key GitKey) *GitClient {
...
func (m *GitClientManager) Get(key GitKey) (*ManagedClient, error) {
	if m == nil {
