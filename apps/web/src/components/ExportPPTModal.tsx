...
import {
	loadPptTemplateCatalog,
	type PptTemplateItem,
} from "../lib/ppt-template-catalog";
			...
			return (
				<div style={{ textAlign: "center", padding: 40 }}>
					...
					<div style={{ marginTop: 24 }}>
						...
						<Text type="secondary">请稍候，AI 正在为您生成精美的演示文稿</Text>
					</div>
				</div>
			);
		}
